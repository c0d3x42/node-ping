...
Pinger.prototype.pingStderr = function( line )
{
  ...
  if( unreachable_match = line.match( /^ICMP Host Unreachable from (.*)/ ) )
  {
    ...
    var matches = undefined;
    var mo = { };
    //ICMP Host Unreachable from 192.168.7.41 for ICMP Echo sent to www.ofsted.gov.uk (62.128.159.101)
    ...
    // ICMP Host Unreachable from 192.168.33.2 for ICMP Echo sent to 192.168.33.1
